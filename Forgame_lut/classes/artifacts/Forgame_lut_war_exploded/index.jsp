...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/section-banner.css"/>
    <link rel="stylesheet" type="text/css" href="css/section-banner-hot.css"/>
    <link rel="stylesheet" type="text/css" href="css/section-local-depth-travel.css"/>
    <link rel="stylesheet" type="text/css" href="css/section-features.css"/>
...
<header class="header-box">
    ...
    <nav class="nav-box2">
        <div class="center-box2">
            ...
            <a href="weibo.html" class="box1-icon">
                <img src="images/icon-weibo.png">
            </a>
            <a href="weixin.html" class="box1-icon">
                <img src="images/icon-weixin.png">
            </a>
            <a href="login.html" class="box1-login-registered" target="_search">登录</a>
        </div>
    </nav>
</header>
...
<!-- banner轮播图js-->
<script src="js/section-banner.js"></script>
<!-- 菜单动画 -->
